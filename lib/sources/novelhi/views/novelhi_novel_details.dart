...
class NovelHiNovelDetails extends StatefulWidget {
  final Novel novel;
  const NovelHiNovelDetails({super.key, required this.novel});

  @override
  State<NovelHiNovelDetails> createState() => _NovelHiNovelDetailsState();
}

class _NovelHiNovelDetailsState extends State<NovelHiNovelDetails> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    super.initState();
    novel = novelHiService.getChapters(widget.novel);
    loading = false;
